...
<html>
  ...
  <nav class="navbar">
    ...
    <body>
            <center><h1 style="color: white;font-family: sans-serif;font-size: 60px">View leave Employee</h1></center>
  ...
  <table>
   ...
   <tbody>
          <tr>
                                 ...
                                 <td><a href="updateLeaveEmp.jsp?id=<%=id%>">Edit</a></td>
                                 <td><a href="deleteLeave.jsp?id=<%=id%>">Delete</a></td>
          </tr>
   </tbody>
    <%         
                                 }
