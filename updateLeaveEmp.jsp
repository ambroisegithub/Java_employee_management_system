...
<%
    if(request.getParameter("submit")!=null)
    {
        ...
        pst = con.prepareStatement("update leaveapplication set code = ?,description =?,FromDate= ?,ToDate= ?,status= ? where id = ?");
...
<html>
 ...
 <center>
  <div class="container">
     <div class="title">Update Leave Application</div>
    <div class="content">
          ...
          <form  method="POST" action="#" >  
                 ...
                 <%    
                        ...
                        pst = con.prepareStatement("select * from leaveapplication where id = ?");
                        pst.setString(1, id);
                        rs = pst.executeQuery();
          ...
          <div class="input-box">
            ...
            <select id = "salution" name ="code" value="<%= rs.getString("code")%>"  style="width: 650px; height:45px;border-radius:8px">
 ...
 <textarea  id="textarea" name="description"  value="<%= rs.getString("description")%>" cols="90" rows="10"></textarea>
       </div>
...
<!--            <input type="text" placeholder="amount" name="FromDate" style="width: 650px; height:45px;border-radius:8px" required>-->
            <input type="date"  value="<%= rs.getString("FromDate")%>" style="width: 650px; height:45px;border-radius:8px" name="FromDate" required>
          </div>
              <div class="input-box">
  
  <span class="deatils">To Date *</span>
            <input type="date"  value="<%= rs.getString("ToDate")%>" style="width: 650px; height:45px;border-radius:8px" name="ToDate"  required>
</div>
              <div class="input-box">
            ...
            <select id = "Leave Status" name="status"  value="<%= rs.getString("status")%>" style="width: 650px; height:45px;border-radius:8px">
