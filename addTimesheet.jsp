<%-- 
    Document   : addTimesheet
    Created on : Nov 22, 2022, 9:35:00 PM
    Author     : Ambroise
--%>
...
<%
    ...
    {                                                                                     	
        ...
        pst = con.prepareStatement("insert into addtimesheet(Empcode,projectCode,workTitle,workDiscription,totalHours,Date)values(?,?,?,?,?,?)");
        ...
        %>
    <script>  
        alert("Time Sheet  Added Sucussfull ");    
    </script>
    <%            
    }
   %>
...
<center>
  ...
  <div class="container">
    ...
    <div class="content">
        <form action="addTimesheet.jsp" method="POST">
        <div class="user-details">                                                                  

          <div class="input-box">
            <span class="deatils">Select Employee Code *</span>
            <select id = "salution" name ="Empcode">
          ...
          <div class="input-box">
            ...
            <select id = "status"  class="select" aria-placeholder="please select" name= "projectCode">
                <option>month</option>
       ...
       <div class="input-box">
            ...
            <input type="text" placeholder="Work-Title" style="width: 650px; height:45px;border-radius:8px" name="workTitle"  required>
          </div>
          <div class="input-box">
            <span class="deatils">Work Discription*</span>
          
          <textarea id="textarea" cols="90" rows="10" name="workDiscription" ></textarea>
          ...
          <div class="input-box">
            ...
            <input type="text" name="totalHours" placeholder="Work-Hours" style="width: 650px; height:45px;border-radius:8px" required>
          </div>
          <div class="input-box">
            <span class="deatils">Date *</span>
            <input type="text" name="Date" placeholder="Date" style="width: 650px; height:45px;border-radius:8px" required>
          </div>
